...
<nav class="navbar navbar-expand-lg navbar-light bg-info">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" action="search_vehicle.php" method="get">
...
<div class="row px-1">
  <div class="col-md-10">
        ...
        <div class="row">
          <!-- Fetching Products -->
          <?php
          $select_query="Select * from `vehicles` order by rand() LIMIT 0,9";
  ...
  <div class='card-body'>
    ...
    <a href='user.php?add_to_cart=$vehicle_id' class='btn btn-info'>Rent Now</a>
