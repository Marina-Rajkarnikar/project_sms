...
$TEMPPICTURE = $_FILES['picture']['tmp_name'];
    ...
    if (
        ...
        or $cpassword == '' or $IMAGE == '' or $PICTURE == '') {   

        echo "<script>alert('Please fill all the available fields!')</script>";
    } else {
        
        move_uploaded_file($TEMPIMAGE, "userimages/$IMAGE");
         move_uploaded_file($TEMPPICTURE, "userimages/$PICTURE");
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if ($password != $cpassword) {
                ...
                $insert = "INSERT INTO user_table(`username`, `email`, `user_image`, `password`, `user_type`, `user_image1`) 
          VALUES('$username','$email', '$IMAGE', '$password','$user_type', '$PICTURE')";
    ...
    <div class="container-fluid m-3">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-6 col-xl-5">
                <img src="../main/images/about.png" alt="Admin Registration" class="img-fluid">
            </div>
            <div class="col-lg-6 col-xl-4">
                <form action="user_registration.php" method="post" enctype="multipart/form-data">
                    ...
                    <!-- License Upload -->
                    <div class="form-outline mb-2">
                        <label for="picture" class="form-label">Upload License</label>
                        <input type="file" name="picture" id="user_image1" class="form-control" 
                        required="required">
                    </div>
