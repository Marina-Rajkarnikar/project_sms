    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="admin.php?insert_vehicle" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="fas fa-car-crash me-2"></i>Insert Vehicle</a>
                <a href="admin.php?view_vehicles" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="fas fa-bus-alt me-2"></i>View Vehicles</a>
                <a href="admin.php?view_categories" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                ...
                <a href="admin.php?view_brands" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        ...
                        class="fas fa-motorcycle me-2"></i>View Users</a>
                <a href="admin.php?view_bookings" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="fas fa-map-marker-alt me-2"></i>Bookings</a>
                        <a href="admin.php?view_queries" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i
                        class="fas fa-phone-alt me-2"></i>Contact Messages</a>
