...
if (isset($_POST['upload'])) {
  ...
  move_uploaded_file($TEMPIMAGE, "vehicle_images/$IMAGE");
  move_uploaded_file($TEMPPICTURE, "vehicle_images/$PICTURE");
  move_uploaded_file($TEMPPHOTO, "vehicle_images/$PHOTO");
  move_uploaded_file($TEMPPICIMG, "vehicle_images/$PICIMG");
  //insert data
...
<div class="form-outline mb-4 w-50 m-auto">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="price" class="form-control" placeholder="Enter Vehicle Renting Price Per Day" autocomplete="off" required="required">
            </div>
